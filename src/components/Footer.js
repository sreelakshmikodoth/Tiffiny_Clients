...
export default function Footer() {
  ...
  return (
    <Grid container direction="row" className={classes.container}>
      ...
      <Grid item xs={12} sm={4} className={classes.innerCont}>
        {authenticated ? (
          ...
          <>
            ...
            <Typography variant="body1" component="p">
              Get more business by registering as tiffin service provider.
            </Typography>
            <br />
      ...
      <Grid item xs={1} sm={1}/>
      <Grid item xs={12} sm={12} className={classes.resources}>
        <Typography variant="h5" component="p">
        </Typography>
        <Typography variant="body1" component="p" style={{ marginTop: 15,marginBottom: 28 ,align:"center"}}>
        All copyright to<br/>
        Copyright @ slk2020
        </Typography>
      </Grid>

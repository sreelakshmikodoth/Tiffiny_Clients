...
export default function SellerDashboard() {
  ...
  useEffect(() => {
   ...
   useEffect(() => {
     console.log("error keep dialogue open",errors);
    if (errors) {
     setOpen(true);
    }
  }, [errors]);
     ...
     <Grid item xs={12} sm={4} />
        ...
        <Grid item xs={12} sm={10}>
          <Typography
            gutterBottom
            variant="h5"
            style={{ textAlign: "center", marginBottom: 30,marginTop: 40  }}
            noWrap
          >
            Add, Edit, Delete Items in your Service &nbsp;&nbsp;

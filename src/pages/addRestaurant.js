...
export default function AddRestaurant() {
  ...
  const handleFileSelect = (event) => {
    setImages([...(images !== null?  images :[]),event.target.files[0]]);
  };
              ...
              <Grid item sm>
                ...
                <form noValidate onSubmit={handleSubmit}>
                  ...
                  <TextField
                    id="costForOne"
                    name="costForOne"
                    label="Cost For One  week"
                    placeholder="Cost for one week for single person"
                    className={classes.textField}
                    onChange={handleInputChange}
                  ...
                  <TextField
                    id="minOrderAmount"
                    name="minOrderAmount"
                    label="Min Order to be Placed"
                    placeholder="Minimum number of Order to be placed "
                    className={classes.textField}
                    onChange={handleInputChange}
